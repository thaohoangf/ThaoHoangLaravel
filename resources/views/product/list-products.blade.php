...
<div class="content">
    ...
    <div class="breadLine">
        ...
        <ul class="breadcrumb">
            <li><a href="list-products.blade.php">List Products</a></li>
        </ul>
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block-fluid table-sorting">
                    <a href="add-product.blade.php" class="btn btn-add">Add Product</a>
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <tr>
                            ...
                            <td>15:00 05/10/2014</td>
                            <td><a href="edit-product.blade.php" class="btn btn-info">Edit</a></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="checkbox"/></td>
                            <td>2</td>
